    ...
    return (
        <div className="sidebar">
            ...
            <ul>
                ...
                <li>
                    <Link to="/settings" className={isActive("/settings")} style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
                        Settings
                    </Link>
                </li>
                ...
                <li>
                    <Link to="/privacy" className={isActive("/privacy")} style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
                        Privacy Policy
                    </Link>
                </li>
